...
Mount the handler in your framework. The app exposes a `.handler` property that accepts a `Request` and returns a `Response`.

```ts
// Next.js App Router example
export { handler as GET, handler as POST } from "./server";
```
