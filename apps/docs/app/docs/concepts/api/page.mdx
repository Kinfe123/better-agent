...
Mount the handler in any framework that accepts a `Request` object. Keep `baseURL` and the mounted route aligned:
...
See the integration guides for Next.js, SvelteKit, TanStack Start, Remix, Astro, Nuxt, SolidStart, and backend frameworks like Express, Fastify, Hono, Elysia, and NestJS.
