...
The guard context includes `mode` (the request type), `agentName`, `input`, and `request`.
...
For pre-built plugins, see [Auth](/docs/plugins/auth), Rate Limit, Logging, IP Allowlist, and Sandbox.
