---
title: "OpenAI"
description: "Use OpenAI with Better Agent by creating the provider and choosing a model. Quick Start Model Helpers Use the helper that matches the kind of model you want: | "
order: 420
---
