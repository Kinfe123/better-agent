---
title: "xAI"
description: "Use xAI with Better Agent by creating the provider and choosing a model. Quick Start Model Helpers Use the helper that matches the kind of model you want: | Hel"
order: 430
---
